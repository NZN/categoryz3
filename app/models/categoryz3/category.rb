module Categoryz3
  class Category < ActiveRecord::Base
    belongs_to :parent     , class_name: ::Categoryz3.config.category_class, inverse_of: :children   , counter_cache: 'childrens_count'
    has_many :children     , class_name: ::Categoryz3.config.category_class, foreign_key: :parent_id , inverse_of: :parent , dependent: :destroy
